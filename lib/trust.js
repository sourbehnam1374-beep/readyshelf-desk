...
export const SUCCESS_CRITERIA = [
  ...
  "Generate (or ingest) → a Post with status ready, source_id, draft_text, model, prompt_version.",
  "Inbox shows sources and Draft ready.",
  "Review is Source | Draft. No Verified badge.",
  "Approve freezes the exact draft_text. Frozen posts cannot be edited.",
  "Publish sends frozen_text only. Nothing live without Approve.",
